        ...
        <div class="body">
            ...
            <form @submit.prevent="register">
                ...
                <div class="m-form-group">
                    ...
                    <input type="text" id="nameInput" v-model="name" class="form-control" maxlength="255" required>
                ...
                <div class="m-form-group">
                    ...
                    <input type="password" id="passwordInput" v-model="password" class="form-control" minlength="8">
                ...
                <div class="m-form-group">
                    <span style="font-size: 0.8em;">Already have an account? <router-link :to="{ name: 'login' }">Sign
                            in</router-link></span>
                </div>
